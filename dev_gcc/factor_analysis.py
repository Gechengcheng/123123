...
def main():
    df = pd.read_csv(r"验证性因子分析.txt", sep="\t", encoding="gbk")
    # print(df)
    df2 = df.copy()
    print("\n原始数据:\n", df2)
    ...
    print("\n巴特利特球形检验:", bartlett(df2_corr1[0], df2_corr1[1], df2_corr1[2], df2_corr1[3], df2_corr1[4],
                                  ...
                                  df2_corr1[15], df2_corr1[16], df2_corr1[17], df2_corr1[18], df2_corr1[19],
                                  df2_corr1[20], df2_corr1[21], df2_corr1[22], df2_corr1[23], df2_corr1[24],
                                  df2_corr1[25]))
    ...
    # 求公因子个数m,使用前m个特征值的比重大于85%的标准，选出了公共因子是?个
    for m in range(1, 15):
